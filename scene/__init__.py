...
class Scene:
    ...
    def __init__(
        self, args: ModelParams, gaussians: GaussianModel, load_iteration=None, shuffle=True
    ):
        ...
        if self.loaded_iter:
            ...
            self.gaussians.load_from_pcd(scene_info.point_cloud, self.cameras_extent)
